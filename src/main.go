...
func Profiler1() {
	...
	var tR [1]Curve.PointCircuit
	var tS [1]Curve.ElementO     //frontend.Variable
	var tA [1]Curve.PointCircuit //td.Point
	//var tMsg [NVAL]Curve.ElementF   // frontend.Variable
	var tMsg [1][32]uints.U8
...
func Profiler16() {
	...
	var tR [16]Curve.PointCircuit
	var tS [16]Curve.ElementO     //frontend.Variable
	var tA [16]Curve.PointCircuit //td.Point
	//var tMsg [NVAL]Curve.ElementF   // frontend.Variable
	var tMsg [16][32]uints.U8
...
func Profiler32() {
	...
	var tR [32]Curve.PointCircuit
	var tS [32]Curve.ElementO     //frontend.Variable
	var tA [32]Curve.PointCircuit //td.Point
	//var tMsg [NVAL]Curve.ElementF   // frontend.Variable
...
func Profiler48() {
	...
	var tR [48]Curve.PointCircuit
	var tS [48]Curve.ElementO     //frontend.Variable
	var tA [48]Curve.PointCircuit //td.Point
	//var tMsg [NVAL]Curve.ElementF   // frontend.Variable
...
func Profiler64() {
	...
	var tR [64]Curve.PointCircuit
	var tS [64]Curve.ElementO     //frontend.Variable
	var tA [64]Curve.PointCircuit //td.Point
	//var tMsg [NVAL]Curve.ElementF   // frontend.Variable
